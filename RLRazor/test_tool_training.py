"""
Minimal training test for TOOL dataset (4GB CUDA)
Tests SFT training with tool-use examples
"""
import os
import sys
...
print("="*70)
print("MINIMAL TOOL DATASET TRAINING TEST (4GB CUDA)")
print("="*70)
...
# Load TOOL dataset
print("\nLoading TOOL dataset...")
dataset = load_dataset_byname("tool")
print(f"Dataset size: {len(dataset)} tool-use examples")

# Show first example
print("\n" + "-"*70)
print("Sample tool-use example:")
print("-"*70)
example = dataset[0]
...
print("="*70)
print("\nThe model has been trained on tool-use examples!")
print("It learned to output Action/Action Input format for API calls.")
print("="*70)
